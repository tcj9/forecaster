        ...
        <Center height={"100%"} width={"100%"}>
            {
                hourlyForecastData ?
                    <Stack spacing={4} h={"100%"} width={'100%'} direction={'column'}>
                        <ForecastHeaderBar forecastType={"12 Hour"} locationName={hourlyForecastData.locationName} zipCode={props.zipCode} locationColor={"green.500"} updatedOn={hourlyForecastData.updatedOn} />
